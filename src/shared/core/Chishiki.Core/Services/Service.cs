...
/// Inherits from <see cref="AsyncDisposable"/> which provides the async disposal pattern.
/// </remarks>
...
public class Service(ILogger? logger = null, ILoggerFactory? loggerFactory = null) : AsyncDisposable(logger, loggerFactory), IService
{
}
