...
public record PropertySettings(PropertyInfo PropertyInfo)
{
    ...
    /// <summary>
    /// Gets a value indicating whether this <see cref="PropertySettings"/> is sortable.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets a value indicating whether this property is filterable.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets the query operator to use for filtering.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets the query value type for filter conversion.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets a value indicating whether to ignore casing during filtering.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets the fully-qualified enum type name when <see cref="FilterQueryValueType"/> is <see cref="QueryValueType.Enum"/>.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets a value indicating whether this instance is scaffold.
    /// </summary>
    /// <value>
    ...
    /// <summary>
    /// Gets a value indicating whether this <see cref="PropertySettings"/> is required.
    /// </summary>
    /// <value>
