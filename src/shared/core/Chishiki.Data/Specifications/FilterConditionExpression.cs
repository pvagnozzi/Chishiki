...
/// <summary>Represents a filter condition expression in query specifications.</summary>
/// <remarks>
...
public record FilterConditionExpression(
    /// <summary>The name of the property to filter on. .</summary>
    string PropertyName,
    /// <summary>The operator to use for comparison. .</summary>
    FilterConditionOperator ConditionOperator,
    /// <summary>The value to compare against (may be null for null checks). .</summary>
    object? Value = null,
    /// <summary>Indicates whether to ignore casing during string comparisons. .</summary>
