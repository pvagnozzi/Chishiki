...
public interface IUnitOfWork : IDisposable
{
    ...
    /// <summary>Saves all pending changes to the database asynchronously. .</summary>
    /// <param name="cancellationToken">Token to observe for cancellation.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    Task SaveChangesAsync(CancellationToken cancellationToken = default);

    /// <summary>Saves a list of audit entries asynchronously. .</summary>
    ...
    /// <summary>Gets audit entries for a specific authenticated user asynchronously. .</summary>
    /// <typeparam name="T">The audit entity type.</typeparam>
