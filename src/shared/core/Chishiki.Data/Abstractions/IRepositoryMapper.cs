...
/// <summary>
/// Interface for mapping entity types to repository implementations.
/// </summary>
public interface IRepositoryMapper
{
    ...
    /// <summary>
    /// Registers all repository types from the specified assembly.
    /// </summary>
    ...
    /// <summary>
    /// Registers all repository types from the specified assemblies.
    /// </summary>
    ...
    /// <summary>
    /// Gets the repository type for the given entity type.
    /// </summary>
