...
/// <summary>Represents a read-only repository.</summary>
    ...
    where TEntity : class, IEntity<TKey>
{
    ...
    /// <summary>Gets the query provider for the entity. .</summary>
    ...
    /// <summary>Gets an item by identifier asynchronously. .</summary>
    /// <param name="key">The primary key.</param>
    /// <param name="cancellationToken">Token to observe for cancellation.</param>
    /// <returns>The entity if found; otherwise null.</returns>
    Task<TEntity?> GetByIdAsync(TKey key, CancellationToken cancellationToken = default);

    /// <summary>Gets the first element matching the specification or null asynchronously. .</summary>
    ...
    /// <summary>Gets a single element matching the specification or null asynchronously. Throws if more than one match is found. .</summary>
    /// <param name="specification">The specification query.</param>
    /// <param name="cancellationToken">Token to observe for cancellation.</param>
    ...
    /// <summary>Lists all items matching the specification asynchronously. .</summary>
    ...
    /// <summary>Lists a page of items matching the specification asynchronously. .</summary>
    ...
    /// <summary>Gets an item by identifier synchronously. .</summary>
    /// <param name="key">The primary key.</param>
    /// <returns>The entity if found; otherwise null.</returns>
    TEntity? GetById(TKey key);

    /// <summary>Gets the first element matching the specification or null synchronously. .</summary>
    /// <param name="specification">The specification query.</param>
    /// <returns>The first matching entity or null.</returns>
    TEntity? FirstOrDefault(ISpecification<TKey, TEntity> specification);

    /// <summary>Gets a single element matching the specification or null synchronously. Throws if more than one match is found. .</summary>
    /// <param name="specification">The specification query.</param>
    /// <returns>The single matching entity or null.</returns>
    TEntity? SingleOrDefault(ISpecification<TKey, TEntity> specification);

    /// <summary>Lists all items matching the specification synchronously. .</summary>
    /// <param name="specification">The optional specification query.</param>
    /// <returns>List of matching entities.</returns>
    IList<TEntity> List(ISpecification<TKey, TEntity>? specification = null);

    /// <summary>Lists a page of items matching the specification synchronously. .</summary>
    /// <param name="specification">The paged specification query.</param>
    /// <returns>Paged list of matching entities.</returns>
