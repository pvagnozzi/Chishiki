...
/// <summary>Represents a property filter used to build query conditions.</summary>
public interface IPropertyFilter
{
    /// <summary>Gets the raw string value of the filter. .</summary>
    ...
    /// <summary>Gets the value type used for conversion. .</summary>
    /// <value>
    /// The query value type.
    /// </value>
    QueryValueType ValueType { get; }

    /// <summary>Gets the fully-qualified enum type name when <see cref="ValueType"/> is <see cref="QueryValueType.Enum"/>. .</summary>
    /// <value>
