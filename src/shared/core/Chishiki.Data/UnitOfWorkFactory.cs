...
/// <summary>Unit of work factory abstract class.</summary>
...
public abstract class UnitOfWorkFactory(IServiceProvider serviceProvider) : Disposable(null, serviceProvider.GetRequiredService<ILoggerFactory>()), IUnitOfWorkFactory
{
    ...
    /// <summary>Creates a new Unit of Work instance. .</summary>
    ...
    /// <summary>Creates a new Unit of Work instance with the specified repository mapper and logger factory. .</summary>
