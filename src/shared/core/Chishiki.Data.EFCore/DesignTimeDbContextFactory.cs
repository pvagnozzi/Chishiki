...
public abstract class DesignTimeDbContextFactory<T>(string connectionString, string defaultConnectionString)
    ...
    where T : DbContext
{
    /// <summary>Creates a new instance of the database context using the specified command-line arguments. .</summary>
    ...
    /// <summary>Creates an instance of the DbContext using the provided options. This method must be implemented by derived classes to create an instance of the DbContext using the configured options. The implementation should return a new instance of the DbContext, passing the options to its constructor. .</summary>
